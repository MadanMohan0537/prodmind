...
Project 7 is both the experiment workspace and the integration host for the twenty-three-project [ProdMind](../README.md) product. It executes Projects 1–6 directly and imports Projects 8–23 for outcomes, memory, portfolio governance, benefits, assurance, assumption validation, release readiness, adoption measurement, lifecycle governance, and sunset assurance.
...
- **Portfolio value:** provides one D1-backed control plane for all twenty-three modules and preserves the decision trail.
...
- Canonical `portfolioItemId` contracts across Projects 11–23 to prevent cross-run ID collisions
...
Projects 1–6 and 8–23 are bundled through imports for this deployment. Their standalone databases are not automatically copied into the workspace.
...
public/                 Complete twenty-three-stage workspace
